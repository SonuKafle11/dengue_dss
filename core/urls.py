...
urlpatterns = [
    ...
    path('doctor/patient//',         views.doctor_patient_detail,   name='doctor_patient_detail'),
    path('doctor/result//',          views.doctor_prediction_result,name='doctor_prediction_result'),

    # Admin
    path('admin-panel/',                                 views.admin_dashboard,    name='admin_dashboard'),
    path('admin-panel/delete-user//',       views.admin_delete_user,  name='admin_delete_user'),
    path('admin-panel/delete-record//', views.admin_delete_record, name='admin_delete_record'),
