# Generated by Django 4.2 on 2026-07-18 16:52
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('clinical_risk_level', models.CharField(blank=True, choices=[('low', 'Low Risk'), ('high', 'High Risk')], max_length=20)),
                ('platelet_count', models.FloatField(blank=True, null=True)),
                ('wbc_count', models.FloatField(blank=True, null=True)),
                ('ns1', models.FloatField(blank=True, null=True)),
